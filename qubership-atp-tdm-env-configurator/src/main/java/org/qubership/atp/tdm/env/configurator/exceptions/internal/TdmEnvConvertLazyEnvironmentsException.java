...
@ResponseStatus(value = HttpStatus.INTERNAL_SERVER_ERROR, reason = "TDM-5006")
public class TdmEnvConvertLazyEnvironmentsException extends TdmEnvInternalException {

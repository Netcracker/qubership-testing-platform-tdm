                ...
                for (LazyEnvironment environment : environments) {
                    ...
                    if (system.isPresent()) {
                        ...
                        statElement.setSystem(environmentsService
                                .getLazySystemById(UUID.fromString(system.get())).getName());
                        break;
                    }
                }
            }
        ...
        if (!testDataOccupy.isEmpty()) {
            ...
            userNames.forEach(userName -> {
                ...
                tableNames.forEach(tableName -> {
                    ...
                    try {
                        systemName = environmentsService
                                .getLazySystemById(tableCatalog.getSystemId()).getName();
                    } catch (Exception e) {
    ...
    private void fillEnvironmentsAndSystems(
        ...
        occupiedTables.forEach(tableValue -> {
            ...
            if (tableTemp != null) {
                ...
                try {
                    tableValue.setSystem(environmentsService.getLazySystemById(tableTemp.getSystemId()).getName());
                } catch (Exception e) {
